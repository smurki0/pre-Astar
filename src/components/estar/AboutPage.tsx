...
const teamMembers = [
  ...
  },
  {
    ...
    nameAr: ' م/بلال محمد',
    roleEn: 'Designer & Social Media Manager',
    roleAr: 'مصمم ومدير التواصل الاجتماعي',
    image: 'https://i.postimg.cc/7Z8HZXYS/IMG-20260627-WA0003.jpg',
  },
  {
    nameEn: 'Anas Abdallah',
    nameAr: 'أنس عبدالله',
    roleEn: 'Co-founder',
    roleAr: 'المؤسس الثاني',
    image: 'https://i.postimg.cc/44SjJdNW/IMG-20260627-WA0004.jpg',
  },
]
    ...
    <div className="min-h-screen bg-background" dir={dir}>
      ...
      <section className="relative bg-gradient-hero py-20 md:py-32">
        <div className="container mx-auto px-4 text-center">
          ...
          >
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-foreground mb-6">
